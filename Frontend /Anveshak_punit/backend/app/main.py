...
def create_app() -> FastAPI:
    ...
    # Import routers
    from app.api import datasets, objects, analysis, jobs, science_integration

    # Register versioned API routes
    app.include_router(datasets.router, prefix="/api/v1/datasets", tags=["Datasets"])
    app.include_router(objects.router, prefix="/api/v1/objects", tags=["Objects"])
    app.include_router(analysis.router, prefix="/api/v1/analysis", tags=["Analysis"])
    app.include_router(science_integration.router, prefix="/api/v1/science", tags=["Science"])
